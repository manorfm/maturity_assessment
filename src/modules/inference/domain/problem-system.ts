...
export const diagnosticSystemCatalog: DiagnosticSystemDefinition[] = [
  defineSystem('integration-feedback', 'Integração e feedback tardios',
    ['mudanca-isolada', 'integracao-tardia', 'integracao-por-janela', 'empacotamento-manual'],
    ['causa-ferramental-feedback', 'causa-processo-lote', 'causa-fronteira-times', 'causa-acoplamento-entrega'],
  ...
  defineSystem('learning-closure', 'Melhoria sem fechamento e capacidade',
    ['acao-sem-fechamento', 'retrospectiva-sem-fechamento'],
  ...
  defineSystem('governance-trust', 'Governança compensando confiança insuficiente',
    ['controle-indiferenciado', 'controle-sem-feedback', 'controle-sem-proposito', 'seguranca-tardia'],
  ...
  defineSystem('operational-response', 'Detecção, resposta e recuperação',
    ['deteccao-tardia', 'incidente-detectado-por-cliente', 'incidente-depende-do-autor'],
