...
const interventionSeeds: Record<string, InterventionSeed> = {
  ...
  'empacotamento-manual': { title: 'A versão para no passo de preparar e passar de um ambiente ao outro', intervention: 'Registre cada passo manual de uma entrega e automatize primeiro o mais frequente e sujeito a variação, preservando uma origem única do artefato.' },
  ...
  'provisionamento-em-fila': { title: 'Para ter ambiente ou permissão, o time pede e espera outro grupo', intervention: 'Escolha o pedido que mais se repete — ambiente, acesso ou conta — e teste um caminho que o próprio time conclua, com limite e tempo visível.' },
  ...
  'causa-capacidade-tomada-pela-proxima-iniciativa': { title: 'A próxima iniciativa ocupa a capacidade de revisar o resultado anterior', intervention: 'Antes de iniciar todo o próximo trabalho, reserve capacidade para revisar um resultado anterior e agir sobre a evidência encontrada.' },
  ...
  'servico-sem-responsavel': { title: 'O serviço não possui responsabilidade ponta a ponta', intervention: 'Atribua a um grupo a decisão sobre prioridade, risco, mudança e resultado de um serviço e teste essa autoridade no próximo evento.' },
  'responsabilidade-limitada-ao-codigo': { title: 'A responsabilidade termina no código', intervention: 'Una mudança e acompanhamento operacional numa responsabilidade verificável para um serviço antes de ampliar a fronteira.' },
  'responsabilidade-compartilhada-sem-decisao': { title: 'Responsabilidade compartilhada não define quem decide', intervention: 'Defina direitos de decisão e uma interface explícita entre os grupos para um tipo recorrente de mudança.' },
  'responsabilidade-depende-de-especialista': { title: 'A responsabilidade acompanha uma pessoa', intervention: 'Transfira uma decisão real para um grupo, com colaboração temporária da referência e verificação sem sua presença.' },
  'legado-sem-modelo-recuperavel': { title: 'O comportamento do legado não pode ser reconstruído', intervention: 'Reconstrua uma fatia crítica com exemplos de uso, telemetria e testes de caracterização antes de alterá-la.' },
  'legado-muda-por-tentativa': { title: 'O legado muda por tentativa e correção', intervention: 'Crie uma prova reproduzível do comportamento atual e reduza o lote da próxima alteração antes de expandir a mudança.' },
  'legado-congelado-ate-reescrita': { title: 'O legado permanece congelado à espera de reescrita', intervention: 'Escolha uma fronteira pequena e extraia uma mudança reversível que reduza risco agora, sem depender da substituição completa.' },
  'legado-dependente-de-fornecedor': { title: 'O legado depende de conhecimento externo', intervention: 'Condicione a próxima mudança a execução conjunta, evidência transferível e repetição posterior pelo grupo interno.' },
  ...
  'competencia-inexistente': { title: 'A organização ainda não possui experiência para a decisão crítica', intervention: 'Reduza o primeiro escopo e combine especialista temporário com execução interna acompanhada, deixando uma segunda pessoa capaz de repetir o caso.' },
  'competencia-concentrada': { title: 'Conhecimento crítico permanece concentrado em poucas pessoas', intervention: 'Faça a próxima mudança com dupla atuação e transfira uma decisão verificável, acompanhando se outra pessoa conclui sem devolver o trabalho.' },
  'competencia-bloqueada-por-acesso': { title: 'Pessoas preparadas não conseguem praticar com segurança', intervention: 'Teste acesso supervisionado, mínimo e temporário numa operação real, preservando revisão e trilha até demonstrar execução segura.' },
  'aprendizado-sem-oportunidade-pratica': { title: 'Capacitação não alcança o trabalho real', intervention: 'Ligue o próximo aprendizado a uma tarefa real pequena, com apoio disponível e critério de execução independente.' },
  'competencia-dependente-de-fornecedor': { title: 'Fornecedor executa sem transferir capacidade operacional', intervention: 'Inclua uma entrega equivalente conduzida pelo time, com fornecedor apoiando e registrando decisões, antes do próximo aceite.' },
  'aprendizado-impedido-por-carga': { title: 'Entregas e urgências consomem a oportunidade de aprender', intervention: 'Reduza temporariamente escopo ou trabalho em andamento para proteger uma aplicação real acompanhada e revisar o efeito.' },
