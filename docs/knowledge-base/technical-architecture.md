...
`capability-reference-v3`. `CapabilityReference` rejeita base de avaliação nominal,
...
autonomia de plataforma, competência técnica e o meta-sistema organizacional; inferência e relatório ainda não
...
feedback técnico durante a construção. As seis referências vigentes atingem
