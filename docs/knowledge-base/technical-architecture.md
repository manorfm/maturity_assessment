...
`capability-reference-v2`. `CapabilityReference` rejeita base de avaliação nominal,
...
autonomia de plataforma e o meta-sistema organizacional; inferência e relatório ainda não
...
feedback técnico durante a construção. As cinco referências vigentes atingem
