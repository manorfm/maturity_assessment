...
`capability-reference-v12`. `CapabilityReference` rejeita base de avaliação nominal,
...
autonomia de plataforma, competência técnica, segurança de software, evolutibilidade, aprendizado organizacional, ownership, governança habilitadora, liderança, colaboração, direção de produto, gestão de portfólio e o meta-sistema organizacional; inferência e relatório ainda não
...
feedback técnico durante a construção. As quinze referências vigentes atingem
