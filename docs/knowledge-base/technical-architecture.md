...
`capability-reference-v5`. `CapabilityReference` rejeita base de avaliação nominal,
...
autonomia de plataforma, competência técnica, segurança de software, evolutibilidade e o meta-sistema organizacional; inferência e relatório ainda não
...
feedback técnico durante a construção. As oito referências vigentes atingem
