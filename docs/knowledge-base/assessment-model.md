...
A referência vigente `capability-reference-v8` materializa rubricas para
...
`enabling-governance` e `organizational-system`. Cada contrato possui propósito, cinco âncoras de
...
No corte atual, as onze referências atingem cobertura mínima. Em feedback
