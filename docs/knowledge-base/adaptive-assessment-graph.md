...
A versão pré-piloto vigente `evidence-anamnesis-pilot-v14` começa por uma escolha neutra de
...
jornada. Para `evidence-anamnesis-pilot-v14`, ela registra quantidade e tipo de nós,
...
Por definição, não contém causa, capacidade ou pontuação. Cinco reconstruções usam
esse contrato: mudança pronta, ambiente/acesso, risco de segurança, decisão entre
fronteiras e melhoria do sistema de trabalho. Cada uma separa a âncora recente de
uma consequência, aprendizado ou fato que faria revisar a interpretação.
