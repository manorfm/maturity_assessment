...
- A página da disciplina deixou os três blocos de escopo; abre com
  o que o recorte não é, depois a dor local, o efeito e o teste; ver
  [`recommendation-model.md`](../knowledge-base/recommendation-model.md).

## 2026-09-06 — Mapa da home só com finding publicado

- Chip e faixa da first plane acendem só com causa publicada; pasta
  vazia fica no mapa fechado; ver
  [`recommendation-model.md`](../knowledge-base/recommendation-model.md).

## 2026-09-06 — Sintético de anamnese em três capítulos

- O caso opaco publica a mesma evidência em Produto, Engenharia e
  Gestão com nomes locais; o capítulo lista todas as intersecções
  já publicadas; ver
  [`recommendation-model.md`](../knowledge-base/recommendation-model.md).
...
- `OrganizationalAreaProjector` desenha Produto, Engenharia e Operação; qualidade,
  plataforma e segurança ficam sob Engenharia; Gestão é faixa; ver
  [`assessment-model.md`](../knowledge-base/assessment-model.md) e
  [`technical-architecture.md`](../knowledge-base/technical-architecture.md).
...
- Publicado `capability-reference-v15` com cinco estágios para isolamento,
  composição, retorno e correção do caminho, e `evidence-anamnesis-pilot-v16`
  com consequência factual sob pressão; ver
  [`assessment-model.md`](../knowledge-base/assessment-model.md),
  [`adaptive-assessment-graph.md`](../knowledge-base/adaptive-assessment-graph.md) e
  [`technical-architecture.md`](../knowledge-base/technical-architecture.md).

## 2026-09-03 — Referência comportamental de planejamento e refinamento

- Publicado `capability-reference-v14` com cinco estágios para preparação
  suficiente, compromisso reversível e aprendizado durante a construção, e
  `evidence-anamnesis-pilot-v15` com consequência factual; ver
  [`assessment-model.md`](../knowledge-base/assessment-model.md),
  [`adaptive-assessment-graph.md`](../knowledge-base/adaptive-assessment-graph.md) e
  [`technical-architecture.md`](../knowledge-base/technical-architecture.md).
...
- Publicado `capability-reference-v9` com cinco estágios para decisões sobre risco,
  carga, conflito, capacidade e resultado, sem diagnosticar pessoas; ver
  [`assessment-model.md`](../knowledge-base/assessment-model.md) e
  [`technical-architecture.md`](../knowledge-base/technical-architecture.md).

## 2026-09-03 — Referência comportamental de governança habilitadora

- Publicado `capability-reference-v8` com cinco estágios para proporcionalidade,
  evidência decisória, autonomia segura e revisão de controles pelo efeito; ver
  [`assessment-model.md`](../knowledge-base/assessment-model.md) e
  [`technical-architecture.md`](../knowledge-base/technical-architecture.md).

## 2026-09-03 — Referência comportamental de ownership

- Publicado `capability-reference-v7` com cinco estágios ligando responsabilidade,
  autoridade, capacidade e consequência, sem penalizar colaboração compartilhada
  explícita; ver [`assessment-model.md`](../knowledge-base/assessment-model.md) e
  [`technical-architecture.md`](../knowledge-base/technical-architecture.md).

## 2026-09-03 — Referência comportamental de aprendizado

- Publicado `capability-reference-v6` com cinco estágios baseados no fechamento do
  ciclo e na mudança do evento seguinte, preservando bloqueios fora da autonomia do
  grupo; ver [`assessment-model.md`](../knowledge-base/assessment-model.md) e
  [`technical-architecture.md`](../knowledge-base/technical-architecture.md).

## 2026-09-03 — Referência comportamental de evolutibilidade

- Publicado `capability-reference-v5` com cinco estágios baseados no custo e no
  aprendizado da mudança equivalente seguinte, sem pontuar estilo arquitetural;
  ver [`assessment-model.md`](../knowledge-base/assessment-model.md) e
  [`technical-architecture.md`](../knowledge-base/technical-architecture.md).
...
- Entregue a versão 0.38 com discriminação de obrigação, risco contextual,
  feedback técnico, ownership, segregação, eficácia e acúmulo de controles; ver
  [`adaptive-assessment-graph.md`](../knowledge-base/adaptive-assessment-graph.md) e
  [`recommendation-model.md`](../knowledge-base/recommendation-model.md).
...
- Entregue a versão 0.36 com investigação causal de funding temporário, ownership
  encerrado no aceite, capacidade tomada pela próxima iniciativa e incentivo por
  entrega; ver
  [`adaptive-assessment-graph.md`](../knowledge-base/adaptive-assessment-graph.md) e
  [`recommendation-model.md`](../knowledge-base/recommendation-model.md).
