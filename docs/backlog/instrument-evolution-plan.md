...
contextuais. Grafo pré-piloto vigente: `evidence-anamnesis-pilot-v16`.
...
começado sobre `evidence-anamnesis-pilot-v16`.
...
`evidence-anamnesis-pilot-v16`**, incluindo as nove perspectivas, o contexto de trabalho e as trilhas curtas de evento.
...
`evidence-anamnesis-pilot-v16`. Resta:
