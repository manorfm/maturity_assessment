...
contextuais. Grafo pré-piloto vigente: `evidence-anamnesis-pilot-v17`.
...
começado sobre `evidence-anamnesis-pilot-v17`.
...
`evidence-anamnesis-pilot-v17`**, incluindo as nove perspectivas, o contexto de trabalho e as trilhas curtas de evento.
...
`evidence-anamnesis-pilot-v17`. Resta:
