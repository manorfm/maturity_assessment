...
contextuais. Grafo pré-piloto vigente: `evidence-anamnesis-pilot-v10`.
...
começado sobre `evidence-anamnesis-pilot-v10`.
...
`evidence-anamnesis-pilot-v10`**, incluindo as nove perspectivas, o contexto de trabalho e as cinco reconstruções iniciais de evento.
...
`evidence-anamnesis-pilot-v10`. Resta:
