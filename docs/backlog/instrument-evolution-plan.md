...
contextuais. Grafo pré-piloto vigente: `evidence-anamnesis-pilot-v18`.
...
começado sobre `evidence-anamnesis-pilot-v18`.
...
`evidence-anamnesis-pilot-v18`**, incluindo as nove perspectivas, o contexto de trabalho e as trilhas curtas de evento.
...
`evidence-anamnesis-pilot-v18`. Resta:
