...
contextuais. Grafo pré-piloto vigente: `evidence-anamnesis-pilot-v14`.
...
começado sobre `evidence-anamnesis-pilot-v14`.
...
`evidence-anamnesis-pilot-v14`**, incluindo as nove perspectivas, o contexto de trabalho e as trilhas curtas de evento.
...
`evidence-anamnesis-pilot-v14`. Resta:
